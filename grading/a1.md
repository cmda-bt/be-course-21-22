...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="center">Data is stored in MongoDB and changed (retrieved and updated) in the database through the client-side of the web app</td>
      <td align="center">Special care was taken to create a performant or secure web app and database</td>
    ...
    <tr>
      ...
      <td align="center">The student can explain some parts of their code, how some parts works together</td>
    ...
    <tr>
      ...
      <td align="center">The code is readable but inconsistent, the process is partially documented, repo contains files that are unnecessary</td>
      <td align="center">The code is consistent docs cover the process and what the project is and does, the repo doesn't contain unnecessary files  </td>
      <td align="center">Special care was taken to create a modular and consist application structure, code adheres to standards</td>
